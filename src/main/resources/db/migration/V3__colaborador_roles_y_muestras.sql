...
INSERT INTO colaborador (
    id_colaborador, id_rol, username, nombre, apellido, email, telefono, cedula,
    numero_licencia, especialidad, departamento, area_laboratorio, activo,
